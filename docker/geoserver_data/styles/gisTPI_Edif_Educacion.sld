...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>Edif_Educacion</se:Name>
    <UserStyle>
      <se:Name>Edif_Educacion</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Escuela Provincial</se:Name>
          <se:Description>
            <se:Title>Escuela Provincial</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Escuela Provincial</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#6edabb</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:MinScaleDenominator>529022</se:MinScaleDenominator>
          <se:MaxScaleDenominator>2108220</se:MaxScaleDenominator>
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>square</se:WellKnownName>
        ...
        <se:Rule>
          ...
          <se:MaxScaleDenominator>529022</se:MaxScaleDenominator>
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>square</se:WellKnownName>
