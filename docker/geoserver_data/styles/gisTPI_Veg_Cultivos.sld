...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0">
  <NamedLayer>
    <se:Name>Veg_Cultivos</se:Name>
    <UserStyle>
      <se:Name>Veg_Cultivos</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Plantaciones Perennes</se:Name>
          <se:Description>
            <se:Title>Plantaciones Perennes</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Plantaciones Perennes</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
              ...
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    <se:WellKnownName>horline</se:WellKnownName>
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#59a351</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>Terreno para Cultivo</se:Name>
          <se:Description>
            <se:Title>Terreno para Cultivo</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Terreno para Cultivo</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
