...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>Estructuras_portuarias</se:Name>
    <UserStyle>
      <se:Name>Estructuras_portuarias</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Fondeadero para Naves de Gran Calado (de 18 pies o más)</se:Name>
          <se:Description>
            <se:Title>Fondeadero para Naves de Gran Calado (de 18 pies o más)</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Fondeadero para Naves de Gran Calado (de 18 pies o más)</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Displacement>
                <se:DisplacementX>0</se:DisplacementX>
                <se:DisplacementY>-3.5</se:DisplacementY>
              </se:Displacement>
            </se:Graphic>
          </se:PointSymbolizer>
          <se:PointSymbolizer>
        ...
        <se:Rule>
          <se:Name>Puerto Comercial</se:Name>
          <se:Description>
            <se:Title>Puerto Comercial</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Puerto Comercial</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:MinScaleDenominator>3000000</se:MinScaleDenominator>
          <se:MaxScaleDenominator>6000000</se:MaxScaleDenominator>
        ...
        <se:Rule>
          ...
          <se:MaxScaleDenominator>12073100</se:MaxScaleDenominator>
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>circle</se:WellKnownName>
