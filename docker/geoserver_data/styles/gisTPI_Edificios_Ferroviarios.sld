...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>Edificios_Ferroviarios</se:Name>
    <UserStyle>
      <se:Name>Edificios_Ferroviarios</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Apeadero, Parada, Embarcadero</se:Name>
          <se:Description>
            <se:Title>Apeadero, Parada, Embarcadero</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Apeadero, Parada, Embarcadero</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
        ...
        <se:Rule>
          <se:Name>Estación de Ferrocarril</se:Name>
          <se:Description>
            <se:Title>Estación de Ferrocarril</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Estación de Ferrocarril</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
