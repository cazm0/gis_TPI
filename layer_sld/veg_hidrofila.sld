...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <se:Name>veg_Hidrofila</se:Name>
    <UserStyle>
      <se:Name>veg_Hidrofila</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Pajonal, Malezal, Cardal, Cortaderal, Españal, Jarillal, Quiscal, Juncal, Totoral</se:Name>
          <se:Description>
            <se:Title>Pajonal, Malezal, Cardal, Cortaderal, Españal, Jarillal, Quiscal, Juncal, Totoral</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tipo</ogc:PropertyName>
              <ogc:Literal>Pajonal, Malezal, Cardal, Cortaderal, Españal, Jarillal, Quiscal, Juncal, Totoral</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#00df2e</se:SvgParameter>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    <se:WellKnownName>asterisk_fill</se:WellKnownName>
                    <se:Fill>
                      <se:SvgParameter name="fill">#13e41d</se:SvgParameter>
                    </se:Fill>
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#232323</se:SvgParameter>
            ...
            <se:VendorOption name="graphic-margin">4.5 4.5</se:VendorOption>
          </se:PolygonSymbolizer>
        </se:Rule>
        <se:Rule>
          <se:Name>Pajonal, Malezal, Cardal, Cortaderal, Españal, Jarillal, Quiscal, Juncal, Totoral</se:Name>
              ...
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#2f7c34</se:SvgParameter>
                      <se:SvgParameter name="stroke-width">1</se:SvgParameter>
                    </se:Stroke>
                  </se:Mark>
                  <se:Size>7</se:Size>
