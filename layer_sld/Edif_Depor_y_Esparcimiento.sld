...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" version="1.1.0">
  <NamedLayer>
    <se:Name>Edif_Depor_y_Esparcimiento</se:Name>
    <UserStyle>
      <se:Name>Edif_Depor_y_Esparcimiento</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:MaxScaleDenominator>3458280</se:MaxScaleDenominator>
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
        ...
        <se:Rule>
          <se:Name></se:Name>
          <se:MinScaleDenominator>3458280</se:MinScaleDenominator>
          <se:MaxScaleDenominator>27150000</se:MaxScaleDenominator>
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>circle</se:WellKnownName>
